...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14332 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14332 = (function (val,box,meta14333){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14332.cljs$lang$type = true;
cljs.core.async.impl.channels.t14332.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14332";
cljs.core.async.impl.channels.t14332.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t14332");
});
cljs.core.async.impl.channels.t14332.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14332.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14334){var self__ = this;
var _14334__$1 = this;return self__.meta14333;
});
cljs.core.async.impl.channels.t14332.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14334,meta14333__$1){var self__ = this;
var _14334__$1 = this;return (new cljs.core.async.impl.channels.t14332(self__.val,self__.box,meta14333__$1));
});
cljs.core.async.impl.channels.__GT_t14332 = (function __GT_t14332(val__$1,box__$1,meta14333){return (new cljs.core.async.impl.channels.t14332(val__$1,box__$1,meta14333));
});
}
return (new cljs.core.async.impl.channels.t14332(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14335 = self__.takes.pop();if((taker_14335 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14335))
{var take_cb_14336 = cljs.core.async.impl.protocols.commit.call(null,taker_14335);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14336,taker_14335,this$__$1){
return (function (){return take_cb_14336.call(null,null);
});})(take_cb_14336,taker_14335,this$__$1))
);
} else
{}
{
