...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14326 = (0);while(true){
var m_14327 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14327 == null))
{} else
{m_14327.call(null);
if((count_14326 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14328 = (count_14326 + (1));
count_14326 = G__14328;
continue;
}
} else
{}
