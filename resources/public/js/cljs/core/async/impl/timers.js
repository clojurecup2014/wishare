...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_14233 = (0);while(true){
if((i_14233 < arr.length))
{(arr[i_14233] = null);
{
var G__14234 = (i_14233 + (1));
i_14233 = G__14234;
continue;
}
} else
...
{var i_14240 = (self__.level + (1));while(true){
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14242 = (0);while(true){
if((i_14242 <= self__.level))
{var links_14243 = (update[i_14242]).forward;if(((links_14243[i_14242]) === x__$1))
{(links_14243[i_14242] = (x__$1.forward[i_14242]));
{
