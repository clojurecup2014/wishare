...
wishare.core.state = cljs.core.atom.call(null, 0);
window.setInterval(function() {
  return cljs.core.swap_BANG_.call(null, wishare.core.state, function(x) {
    var el = document.getElementById("animation");
    el.textContent = (new cljs.core.PersistentArrayMap(null, 4, [0, "(o  )..(o  )", 1, "( o )..( o )", 2, "(  o)..(  o)", 3, "( o )..( o )"], null)).call(null, x);
    if (x < 3) {
      return x + 1;
    } else {
      return 0;
